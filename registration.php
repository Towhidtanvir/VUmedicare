     ...
     if (!isset($_GET['category']))
      ...
      {?>
       <form action="registration.php" method="post" enctype='multipart/form-data' >
        <h3 align="center">Please Complete Registration Form</h3>
        <h5 align="center" style="color: red;">(Must Fill up fields with '*' mark)</h5>
        <table style="text-align: left;margin: auto;width: 400px; ">
          ...
          <tr><td colspan="2"><input class="btn btn-primary" type="submit" name="submit" value="submit"></td><td></td></tr>
        </table>  
       </form> 
      </div>
 <?php } ; ?>
